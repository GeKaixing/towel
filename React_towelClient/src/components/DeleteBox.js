        ...
        <>
            {showModal && < Portal >
                <div className='flex flex-col w-[200px] justify-center items-center space-y-2 ' onClick={e => e.stopPropagation()} >
                    ...
                    {children}
                    <Link to={`/privatechat/${postUserId}`} className='w-[150px] h-[50px] bg-[--boxColor] flex justify-center items-center rounded-my-rounded-10px hover:bg-[--boxHoverColor] hover:text-[--hostColor]' >私信</Link>
