...
import useLocalStorage from '../../../hooks/useLocaStorage.ts';
import { privateChatContext } from '../../../store/privateChat.tsx';

export default function PrivateChat() {
    const [textLength, setTextLength] = useState('');
    const {privateChatData,setPrivateChatData}=useContext(privateChatContext)as{privateChatData:any,setPrivateChatData:any}
